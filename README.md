...
src ---- 程序员源代码的地方
    ...
    ---- icons 文件夹放置一些 svg 矢量图
    ---- layout 文件夹放置一些组件与混入mixin
    ---- router 文件夹与路由相关
    ---- store 文件夹 Vuex 相关
    ---- utils request.js 是 axios 的二次封装文件夹
    ---- views 文件夹放置路由组件
    ---- permission.js 导航守卫相关
    ---- settings 项目的配置项文件
    ---- .env.development webpack 配置文件 开发环境配置
         .env.producation webpack 配置文件 上线环境配置
         .env.staging     webpack 配置文件 测试环境配置
         在 main.js 打印 console.log(process.env) 可以拿到上述配置数据